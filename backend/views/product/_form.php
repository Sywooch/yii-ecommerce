        ...
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="#products" aria-controls="products" role="tab"
              ...
              <li role="presentation"><a href="#characteristics" aria-controls="characteristics" role="tab"
                 ...
                 <li role="presentation"><a href="#dimensions" aria-controls="dimensions" role="tab"
                     data-toggle="tab"><?= Yii::t('shop', 'Dimensions') ?></a></li>

                     <li role="presentation"><a href="#prices" aria-controls="prices" role="tab"
                         data-toggle="tab"><?= Yii::t('shop', 'Prices') ?></a></li>
                         <li role="presentation"><a href="#storages" aria-controls="storages" role="tab"
                             data-toggle="tab"><?= Yii::t('shop', 'Storages') ?></a></li>                          

                             <li class="<?= ($model->isNewRecord) ? ('disabled') : (''); ?>" role="presentation">
                                <a href="#options" aria-controls="options" role="tab" <?= (!$model->isNewRecord) ? ('data-toggle="tab"') : (''); ?> ><?= Yii::t('shop', 'Product Options') ?></a>
                            </li>
                    ...
                    <div class="box-body">
                        <div class="tab-content" role="tablist">
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="characteristics">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="storages">

                                    <div class="product-form">
                                        <?php
                                        if (isset($model->productStorages)) {
                                            $val=[];
                                            foreach ($model->productStorages as $value) {
                                                $val[] = $value->storage_id;
                                            }
                                        }

                                        $model->relStorages = $val;
                                        ?>
                                        <?=
                                        $form->field($model, 'relStorages')->widget(Select2::classname(), [
