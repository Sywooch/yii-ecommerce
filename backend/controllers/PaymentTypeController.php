            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index'],
                        'allow' => true,
                        'roles' => [PaymentType::LIST_PAYMENT_TYPE]
                    ],
                    [
                        'actions' => ['view'],
                        'allow' => true,
                        'roles' => [PaymentType::VIEW_PAYMENT_TYPE]
                    ],
                    [
                        'actions' => ['create'],
                        'allow' => true,
                        'roles' => [PaymentType::CREATE_PAYMENT_TYPE]
                    ],
                    [
                        'actions' => ['update'],
                        'allow' => true,
                        'roles' => [PaymentType::UPDATE_PAYMENT_TYPE]
                    ],
                    [
                        'actions' => ['delete'],
                        'allow' => true,
                        'roles' => [PaymentType::DELETE_PAYMENT_TYPE]
                    ]
                ],
            ],
            'verbs' => [
